...
public class InvestHisoryListAdapter extends RecyclerView.Adapter<InvestHisoryListAdapter.InvestHisoryViewHolder> {
    public ArrayList<RnsSttusInqHist> items;
    private static ClickListener clickListener;
    private Context context;
    CommonUtils mCommonUtil;

    public InvestHisoryListAdapter(Context context) {
        this.context = context;
        mCommonUtil = new CommonUtils(context);
    }

    public void setItems(ArrayList<RnsSttusInqHist> mItems) {
        this.items = mItems;
    }
    ...
    @Override
    public InvestHisoryListAdapter.InvestHisoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(InvestHisoryViewHolder holder, int position) {
        holder.tv_invest_history_sttussn.setText(mCommonUtil.changeNullValue(String.valueOf(items.get(position).getSttusSn()), "-"));
