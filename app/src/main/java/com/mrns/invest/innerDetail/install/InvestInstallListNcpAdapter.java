...
public class InvestInstallListNcpAdapter extends RecyclerView.Adapter<InvestInstallListNcpAdapter.InvestInstallViewHolder> {
    public ArrayList<RnsNpUnityBf> items;
    private static ClickListener clickListener;
    private Context context;

    public InvestInstallListNcpAdapter(Context context) {
        this.context = context;
    }

    public void setItems(ArrayList<RnsNpUnityBf> mItems) {
        this.items = mItems;
    }
    ...
    @Override
    public InvestInstallListNcpAdapter.InvestInstallViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_invest_ncp_install, parent, false);
    ...
    public void onBindViewHolder(InvestInstallViewHolder holder, int position) {
        holder.tv_invest_install_instlsn.setText(String.valueOf(items.get(position).getNpuBfSn()));
        holder.tv_invest_install_instlse.setText(items.get(position).getInqDe());
        holder.tv_invest_install_instlde.setText(items.get(position).getLayDe());
        holder.tv_invest_install_instlnm.setText(items.get(position).getInstlInsttNm());
    }
