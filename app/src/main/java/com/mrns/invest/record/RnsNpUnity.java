...
@Table
public class RnsNpUnity extends SugarRecord {
        private   long NpuSn;
    ...
    public static RnsNpUnity FindByNpuSn(long NpuSn) {
        List<RnsNpUnity> list = RnsNpUnity.find(RnsNpUnity.class, "NPU_SN=?", String.valueOf(NpuSn));
