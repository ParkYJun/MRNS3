...
@EActivity(R.layout.activity_map_capture_ncp)
public class MapCaptureNcpActivity extends AppCompatActivity {
    String exType;
    String exFid;
    String exDate;
    ...
    public void loadingDialog(boolean view, String message) {
        if (view)
            FineDialog.showProgress(MapCaptureNcpActivity.this, false, message);
        else
