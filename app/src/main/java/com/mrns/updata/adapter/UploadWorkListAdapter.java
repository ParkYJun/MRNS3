...
public class UploadWorkListAdapter extends RecyclerView.Adapter<UploadWorkListAdapter.UploadWorkViewHolder> {

    public ArrayList<UploadWorkRecord> items;
    private static ClickListener clickListener;
    private Context context;
    private CommonUtils mCommonUtils;

    public UploadWorkListAdapter(Context context) {
        this.context = context;
        mCommonUtils = new CommonUtils(context);
    }

    public void setItems(ArrayList<UploadWorkRecord> mItems) {
        this.items = mItems;
    }
    ...
    @Override
    public UploadWorkListAdapter.UploadWorkViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
