...
public class UploadFinishNcpFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState ) {
        return inflater.inflate( com.mrns.main.R.layout.activity_upload_tab_finish, container, false );
    }
    ...
    public void onViewCreated(View view, Bundle saveInstanceState) {
        ...
        //List set
        finishList = (ListView) view.findViewById(com.mrns.main.R.id.FinishList);
        ...
        userId = preSession.getString("usid", "");
...
/*
                ...
                movePage = UploadFinishDetailNcpActivity_.intent(view.getContext()).get();
    ...
    void doMakeFinishListWeb(final int pNo) {
        investFinishListUrl = getString(com.mrns.main.R.string.server_ip) + getString(com.mrns.main.R.string.req_finishlist_ncp);
        ...
        public void onResponse(String reponse)
        {
            ...
            try {
                ...
                for(int i=0; i< listCount; i++) {
                    ...
                    String inq_sttus = "3";
                    int npsi_bf_sn = jObject.getInt("npsi_bf_sn");

                    Resources fRes = getResources();
                    fAdapter.addItem(new FinishList_Item(
                            getColorCode(points_knd_cd), points_nm, getMTRSTTUS(mtr_sttus_cd), inq_de, getViewStu(inq_sttus), npsi_bf_sn, fRes.getDrawable(com.mrns.main.R.drawable.btn_map_point_n)));
                }
    ...
    void doMakeFinishList(int pno){
        ...
        try {
            helper = new DBHelper(getContext(), getString(com.mrns.main.R.string.db_full_name), null, 1);
            ...
            //get totPage
            String countSql = "SELECT npu_sn FROM RNS_NP_STTUS_INQ_BF WHERE inq_sttus = 3";
            ...
            while (result.moveToNext()) {
                ...
                fAdapter.addItem(new FinishList_Item(
                        getColorCode(points_knd_cd), points_nm, getMTRSTTUS(mtr_sttus_cd), inq_de, getViewStu(inq_sttus), npu_sn, fRes.getDrawable(com.mrns.main.R.drawable.btn_map_point_n)));
            }

            result.close();

        }catch (NullPointerException e) {
            Log.e(getString(com.mrns.main.R.string.nullPointerException), e.getMessage());
        }finally {
            DatabaseManager.getInstance().closeDatabase();
            Log.i(getString(com.mrns.main.R.string.done), "doMakeFinishList done");
        }
