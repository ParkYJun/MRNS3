...
public class FinishList_Item {
     ...
     * @param obj
     */
    public FinishList_Item(Drawable pIcon, String[] obj, Drawable lIcon) {
        pKindIcon = pIcon;
    ...
    public FinishList_Item(Drawable icon1, String obj1, String obj2, String obj3, String obj4, int workSeq, Drawable icon2) {
        pKindIcon = icon1;
        pLocation = icon2;
        pData = new String[5];
        pData[0] = obj1;
